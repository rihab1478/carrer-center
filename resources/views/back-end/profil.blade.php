        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Votre nom</label>
                  <input type="text" class="form-control" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">Votre prénom</label>
                  <input type="email" class="form-control" id="inputEmail4">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">identifiant</label>
                ...
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">Numéro téléphone</label>
                  <input type="password" class="form-control" id="inputPassword4">
                </div>
                <div class="col-12">
