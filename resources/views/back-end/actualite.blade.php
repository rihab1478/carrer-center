  ...
  <main id="main" class="main">
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Actualités<span>| Aujourd'hui</span></h5>

              <div class="news">
                <div class="post-item clearfix">
                  <img src="{{ url('frontend/img/nn.jpg')}}" alt="">
                  <h4><a href="#">Journées Portes Ouvertes d’Esprit </a></h4>
                  <p>Cet événement est une occasion de présenter l’école, les formations, les débouchés de ces formations et les opportunités d’internationalisation...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="{{ url('frontend/img/formation.jpg')}}" alt="">
                  <h4><a href="#">Workshop Entreprendre et innover</a></h4>
                  <p>Ce workshop a pour objectif de montrer les enjeux et les modalités...</p>
                </div>

                <div class="post-item clearfix">
                  <img src="{{ url('frontend/img/form.jpg')}}" alt="">
                  <h4><a href="#">Forum Esprit Entreprises</a></h4>
                  <p>Le groupe Esprit a reçu ce mercredi une délégation de Le Mans Université...</p>
                </div>
